...
To Run:
mpiexec -n 2 ./hw3.o <X-Dimension> <Y-Dimension> <Generations>

For process count higher than 2 on my machine (my cpu has 2 cores):
mpiexec --oversubscribe -n 4 ./hw3.o <X-Dimension> <Y-Dimension> <Generations>
...
int main(int argc, char **argv) {
  ...
  if (rank == 0) 
  {
      ...
      srand48(MPI_Wtime()); // Seed for random number generation
